      ...
      <?php 
        ...
        foreach ($products->result() as $products) { ?>                        
          <div class="s_item grid_3">
             <a class="s_thumb" href="<?php echo base_url() . 'produk/' . $products->slug;?>"><img src="<?php echo base_url() . 'assets/web/images/image-produk/' . $products->gambar;?>" title="<?php echo $products->nama;?>" alt="<?php echo $products->nama;?>" /></a>   
             <h3><a href="<?php echo base_url() . 'produk/' . $products->slug;?>"><?php echo $products->nama;?></a></h3>
          <?php if($products->promo == 'N'):?>   
             <p class="s_price" style="font-size:19px"><span class="s_currency s_before">Rp</span><?php echo format_rupiah($products->harga);?></p>
          <?php else: ?>
             <p class="s_price s_promo_price" style="font-size:20px"><span class="s_old_price"><span class="s_currency s_before">Rp</span><?php echo format_rupiah($products->harga_lama);?></span><span class="s_currency s_after">Rp</span><?php echo format_rupiah($products->harga);?></p>               
          <?php endif;?>   
