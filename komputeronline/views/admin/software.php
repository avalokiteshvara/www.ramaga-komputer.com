   ...
   <div class="container-fluid">
      <div class="row-fluid">
         ...
         <div class="span4 main-content">
            ...
            <form class="form" action="<?php echo base_url() . 'admin/software';?>" method="POST" enctype="multipart/form-data" />
               <fieldset>
            ...
            <div id="content-ajax">
               <table class="table table-first-column-number ">
                  ...
                  <tbody>
                     <?php 
                        $i = 1;
                        foreach ($data_software->result() as $software) { 
                        ?>
                     <tr>
                        <td><?php echo $i; ?></td>                        
                        ...
                        <!--
                        <td>
                           <a href="<?php echo base_url() . 'admin/software/edit/' . $software->id; ?>" style="color:blue;text-decoration:underline"> 
                           <button type="button" class="btn btn-primary btn-mini">Edit</button> 
                           </a>
                        </td>
                        -->
                        <td>
                           <a href="<?php echo base_url() . 'admin/software/delete/' . $software->id; ?>" style="color:blue;text-decoration:underline">
